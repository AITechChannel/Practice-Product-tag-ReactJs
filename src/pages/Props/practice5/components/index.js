...
import Avatar from '~/pages/Props/practice5/components/ProfileCard/Avatar';
import Contact from '~/pages/Props/practice5/components/ProfileCard/Contact';
import Infor from '~/pages/Props/practice5/components/ProfileCard/Infor';
